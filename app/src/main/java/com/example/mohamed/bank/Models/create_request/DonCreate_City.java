...
public class DonCreate_City {
    ...
    @Expose
    private DonCreate_Govern governorate;
    ...
    public DonCreate_Govern getGovernorate() {
        return governorate;
    }

    public void setGovernorate(DonCreate_Govern governorate) {
