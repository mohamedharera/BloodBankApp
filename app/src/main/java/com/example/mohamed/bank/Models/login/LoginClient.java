package com.example.mohamed.bank.Models.login;
...
public class LoginClient {
    ...
    @Expose
    private LoginBlood_Type bloodType;
    ...
    public LoginBlood_Type getBloodType() {
        return bloodType;
    }

    public void setBloodType(LoginBlood_Type bloodType) {
