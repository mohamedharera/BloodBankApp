...
public class DonCreate_DonationRequest {
    ...
    @SerializedName("city")
    @Expose
    private DonCreate_City city;
    @SerializedName("blood_type")
    @Expose
    private DonCreate_BloodType bloodType;
    ...
    public DonCreate_City getCity() {
        return city;
    }

    public void setCity(DonCreate_City city) {
        this.city = city;
    }

    public DonCreate_BloodType getBloodType() {
        return bloodType;
    }

    public void setBloodType(DonCreate_BloodType bloodType) {
