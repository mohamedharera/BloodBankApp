...
public class DonDetails_City {
    ...
    @Expose
    private DonDetails_Govern governorate;
    ...
    public DonDetails_Govern getGovernorate() {
        return governorate;
    }

    public void setGovernorate(DonDetails_Govern governorate) {
